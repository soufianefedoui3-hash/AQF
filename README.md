...
| `prestart` | avant `npm start` | `prisma db push` + création admin si absent |
...
- Si la base est effacée à chaque redeploy, l'admin est recréé automatiquement au démarrage via `prestart`.
