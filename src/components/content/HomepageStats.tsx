...
export function HomepageStats({
  ...
  return (
    <section className="bg-surface-muted py-14 md:py-16">
      <div className="mx-auto grid max-w-5xl grid-cols-2 items-stretch gap-4 px-4 sm:grid-cols-4 sm:gap-6 sm:px-6">
        {visible.map((stat, index) => {
          const card = (
            <div className="flex h-full flex-col justify-center rounded-2xl border border-primary-100 bg-white p-5 text-center shadow-sm sm:p-6">
